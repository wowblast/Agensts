globals [ max-sheep actual-groups ]  ; don't let sheep population grow too large
...
"" ""
PENS
"sheep together" 1.0 0 -5298144 true "" "plot count sheep with [color = white and leader != self] + count sheep with [color = red]"
